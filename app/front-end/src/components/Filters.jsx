...
function Filters({ hidden }) {
  ...
  return (
    <ul className="filter-list" hidden={ hidden }>
      <li className="filter-item" id="brand" onClick={ handleClick }><span>Marca</span><img className={ brandsVisibility ? 'down' : 'up' } width="10" src={ arrowDown } alt="" /></li>
      ...
      <li className="filter-item" id="year" onClick={ handleClick }><span>Ano</span><img className={ yearsVisibility ? 'down' : 'up' } width="10" src={ arrowDown } alt="" /></li>
      <ul className="item-list" hidden={ yearsVisibility }>
        {
          years.map((year) => <li onClick={ handleClickFilter } className="year" key={ year }>{ year }</li>)
        }
      </ul>
      <li className="filter-item" id="color" onClick={ handleClick }><span>Cor</span><img className={ colorsVisibility ? 'down' : 'up' } width="10" src={ arrowDown } alt="" /></li>
